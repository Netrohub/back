-- NXOLand v2.0 PostgreSQL Database Setup Script (SAFE VERSION)
-- This script handles existing types and tables safely
...
('Seller', 'seller', 'Seller role with product management privileges'),
('Admin', 'admin', 'Administrator role with full access'),
('Moderator', 'moderator', 'Moderator role with content management privileges');
