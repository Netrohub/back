...
# NXOLand Backend Environment Fix and Deployment
# This script fixes the JWT_SECRET issue and deploys the backend

set -e

echo "🔧 Fixing Environment and Deploying Backend..."
...
# Create/update .env file with proper configuration
